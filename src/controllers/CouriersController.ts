...
const log = require('bows')('API:Controller', 'Couriers');
...
export class CouriersController extends BaseController {
  ...
  private getListParams(query: any): ICouriersParams {
    const params: ICouriersParams = this.GetListParams(query) as ICouriersParams;
  ...
  public async list(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const results = await couriersService.list(token, parentWsIds, params);
  ...
  public async get(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const result = await couriersService.get(token, parentWsIds, params);
  ...
  public async create(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      // extract data from req - ie. do NOT send req into service layer
      const ws: ICouriersWS = {
        ...req.body,
        id: undefined
      };
      log('ParentWsIds:', parentWsIds, 'WS:', ws);

      const result = await couriersService.create(token, parentWsIds, ws);
  ...
  public async update(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      await couriersService.update(token, parentWsIds, id, ws);
  ...
  public async patch(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      await couriersService.patch(token, parentWsIds, id, ws);
  ...
  public async delete(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      await couriersService.delete(token, parentWsIds, id);
...
export const couriersController = new CouriersController();
