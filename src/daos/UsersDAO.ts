...
const log = require('bows')('API:DAO', 'Users');
...
export class UsersDAO extends BaseDAO {
  ...
  public async list(token: IToken, parentWsIds: IKVObject, params: IUsersParams): Promise<IApiPagedResponse<IUsersWS>> {
    try {
  ...
  public async get(token: IToken, parentWsIds: IKVObject, params: IUsersParams): Promise<IUsersWS> {
    try {
