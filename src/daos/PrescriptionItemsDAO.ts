...
const log = require('bows')('API:DAO', 'PrescriptionItems');

export class PrescriptionItemsDAO extends BaseDAO {
  constructor() {
    // no op
    super();
  }
  ...
  public async get(token: IToken, parentWsIds: IKVObject, params: IPrescriptionItemsParams): Promise<IPrescriptionItemsWS> {
    try {
