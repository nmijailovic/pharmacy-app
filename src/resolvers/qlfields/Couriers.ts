...
// WS Models
import { ICouriersWS } from '../../interfaces/params/CouriersWS';
...
export class Courier {
  ...
  constructor(token: IToken, parentFieldCtx: IKVObject, { /*SubObjects,*/ ...rest }: ICouriersWS) {
    this.token = token;
  ...
  // resolves Courier.SubObjects field
  ...
  //     id: this.CourierId OR id: this.CourierId.id
