...
// WS Models
import { IDoctorsWS } from '../../interfaces/params/DoctorsWS';
...
export class Doctor {
  ...
  constructor(token: IToken, parentFieldCtx: IKVObject, { /*SubObjects,*/ ...rest }: IDoctorsWS) {
    this.token = token;
  ...
  // resolves Doctor.SubObjects field
  ...
  //     id: this.DoctorId OR id: this.DoctorId.id
