...
// WS Models
import { IPrescriptionItemsWS } from '../../interfaces/params/PrescriptionItemsWS';
...
export class PrescriptionItem {
  ...
  constructor(token: IToken, parentFieldCtx: IKVObject, { /*SubObjects,*/ ...rest }: IPrescriptionItemsWS) {
    this.token = token;
  ...
  // resolves PrescriptionItem.SubObjects field
  ...
  //     id: this.PrescriptionItemId OR id: this.PrescriptionItemId.id
